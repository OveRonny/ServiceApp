...
namespace serviceApp.Server.Migrations
{
    ...
    [Migration("20260806154344_AddFoodStockBatches")]
    partial class AddFoodStockBatches
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("serviceApp.Server.Entities.FoodStorage.FoodStockBatch", b =>
                {
                    ...
                    b.Property<int>("FoodStockItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FoodStockItemId");

                    b.HasIndex("FamilyId", "FoodStockItemId", "BestBeforeDate");

                    b.ToTable("FoodStockBatches");
                });
            ...
            modelBuilder.Entity("serviceApp.Server.Entities.FoodStorage.FoodStockItem", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FrozenOneYearNotificationSentAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("FrozenTwoYearNotificationSentAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("FamilyId", "FrozenDate");
            ...
            modelBuilder.Entity("serviceApp.Server.Entities.FoodStorage.FoodStockWithdrawal", b =>
                {
                    ...
                    b.HasIndex("FamilyId", "RemovedAt");

                    b.ToTable("FoodStockWithdrawals");
                });
            ...
            modelBuilder.Entity("serviceApp.Server.Entities.FoodStorage.FoodStockBatch", b =>
                {
                    b.HasOne("serviceApp.Server.Entities.FoodStorage.FoodStockItem", "FoodStockItem")
                        .WithMany("Batches")
                        .HasForeignKey("FoodStockItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FoodStockItem");
                });
